...
* ############################################################
* D_PCI scenario [2 rows (cost factos) x 4 columns]
...
* ############################################################
* DS_PCI scenario [2 rows (cost factos) x 4 columns x 3 supply realizations]
...
* ############################################################
* D_PCI_IB scenario [1 row (cost factor) x 5 columns (IB)]
...
execute_unload "%resultdir%%version%_report(D-PCI-IB-final).gdx" report_main, report_decomp, report_UBperN, report_UBperG;
* execute_unload "%resultdir%%version%_solution(D-PCI).gdx"
